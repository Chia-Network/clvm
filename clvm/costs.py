...
ARITH_BASE_COST = 1
ARITH_COST_PER_LIMB_DIVIDER = 32
ARITH_COST_PER_ARG = 3

LOG_BASE_COST = 1
LOG_COST_PER_LIMB_DIVIDER = 32
LOG_COST_PER_ARG = 3
...
DIV_BASE_COST = 9
DIV_COST_PER_LIMB_DIVIDER = 32

SHA256_BASE_COST = 2
SHA256_COST_PER_ARG = 1
SHA256_COST_PER_BYTE_DIVIDER = 64

POINT_ADD_BASE_COST = 316
POINT_ADD_COST_PER_ARG = 4200

PUBKEY_BASE_COST = 4194
...
CONCAT_COST_PER_BYTE_DIVIDER = 32

BOOL_BASE_COST = 1
BOOL_COST_PER_ARG = 3

SHIFT_BASE_COST = 4
SHIFT_COST_PER_BYTE_DIVIDER = 32

LOGNOT_BASE_COST = 3
LOGNOT_COST_PER_BYTE_DIVIDER = 32
