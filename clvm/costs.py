...
MALLOC_PER_BYTE_COST = 3

ARITH_BASE_COST = 99
ARITH_COST_PER_BYTE = 3 + MALLOC_PER_BYTE_COST
ARITH_COST_PER_ARG = 320

LOG_BASE_COST = 100
LOG_COST_PER_BYTE = 3 + MALLOC_PER_BYTE_COST
...
DIVMOD_COST_PER_BYTE = 6 + MALLOC_PER_BYTE_COST

DIV_BASE_COST = 988
DIV_COST_PER_BYTE = 4 + MALLOC_PER_BYTE_COST
...
MUL_BASE_COST = 92
MUL_COST_PER_OP = 885
MUL_LINEAR_COST_PER_BYTE = 6 + MALLOC_PER_BYTE_COST
...
CONCAT_COST_PER_BYTE = 3 + MALLOC_PER_BYTE_COST

BOOL_BASE_COST = 200
BOOL_COST_PER_ARG = 300

ASHIFT_BASE_COST = 596
ASHIFT_COST_PER_BYTE = 3 + MALLOC_PER_BYTE_COST

LSHIFT_BASE_COST = 277
LSHIFT_COST_PER_BYTE = 3 + MALLOC_PER_BYTE_COST

LOGNOT_BASE_COST = 331
LOGNOT_COST_PER_BYTE = 3 + MALLOC_PER_BYTE_COST
