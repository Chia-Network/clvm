...
Schema = namedtuple("Schema", ["reduce_f", "keyword_to_int", "keyword_from_int"])
...
def schema_for_name(schema_name="opacity.core_schema"):
    ...
    return Schema(
        reduce_f=mod.do_reduce_f, keyword_to_int=keyword_to_int, keyword_from_int=keyword_from_int)
